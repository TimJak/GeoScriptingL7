...
#Create a variable with the right projection
...
#function to assign the right projection to the specified variable
coordinatesRD <- function(shapefile){
  spTransform(shapefile, prj_string_RD)
}